...
try
    ...
    assert(isfilest(filename), 'cfgload:nofile', 'Configuration file not found.');
    ...
    cfg.vsm.bgsubtract = c.vsm.bgsubtract;
    cfg.vsm.bgsubtractThresh = c.vsm.bgsubtractThresh;
