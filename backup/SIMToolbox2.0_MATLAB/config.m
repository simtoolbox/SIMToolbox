% Copyright © 2013,2014,2015,2016 Pavel Krizek, Tomas Lukes, Jakub Pospisil
% lukestom@fel.cvut.cz
%
...
cfg.msm.eval = [ ...
  struct('fnc', 'mapsim',       'enable', 1), ...
  struct('fnc', 'mapsimCuda',   'enable', 0)];
