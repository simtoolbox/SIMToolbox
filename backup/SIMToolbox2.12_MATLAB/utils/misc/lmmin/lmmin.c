...
/*** allocate work space. ***/
    ...
    if ( (fvec = (double *) mxMalloc(m * sizeof(double))) == NULL ||
	 (diag = (double *) mxMalloc(n * sizeof(double))) == NULL ||
	 (qtf  = (double *) mxMalloc(n * sizeof(double))) == NULL ||
	 (fjac = (double *) mxMalloc(n*m*sizeof(double))) == NULL ||
	 (wa1  = (double *) mxMalloc(n * sizeof(double))) == NULL ||
	 (wa2  = (double *) mxMalloc(n * sizeof(double))) == NULL ||
	 (wa3  = (double *) mxMalloc(n * sizeof(double))) == NULL ||
	 (wa4  = (double *) mxMalloc(m * sizeof(double))) == NULL ||
	 (ipvt = (int *)    mxMalloc(n * sizeof(int)   )) == NULL    ) {
	control->info = 9;
	return;
    }
