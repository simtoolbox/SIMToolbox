function [thr, params] = threshold_std_val(im, params)
% Threshold image by a constant: thr = std(im) * params.thr
%
%   [thr, params] = threshold_std_val(im, params)
%
