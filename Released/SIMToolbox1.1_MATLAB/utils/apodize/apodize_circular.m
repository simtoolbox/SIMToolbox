function [A, params] = apodize_circular(siz, params)
% 2D circular apodizing filter
%
%   [A, params] = apodize_circular(siz, params)
%
...
% Filter definition:
%
%   A = 1   for radius <= params.rad
%   A = 0   otherwise
%
% Example:
%
%   A = apodize_circular([255 255], struct('rad',0.5));
