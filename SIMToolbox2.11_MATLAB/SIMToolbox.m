...
uicontrol('Parent',hmain,'Style','pushbutton','String','Preview',...
    ...
    'Units','pixels','Position',[width+dlgmargin+100,psiz(2)-3*dlgmargin-hBtn,90,hBtn]);

% Preview - z
uicontrol('Parent',hmain,'Style','text','String','z:',...
    'Units','pixels','Position',[width+dlgmargin+200,1+psiz(2)-3*dlgmargin-hBtn,12,hTxt],...
    'HorizontalAlignment','right');

uicontrol('Parent',hmain,'Style','edit',...
    'Tag','editPreviewZ',...
    'Callback','SIMToolbox(''editPreview_Callback'',gcbo,''z'')',...
    'Units','pixels','Position',[width+dlgmargin+212,psiz(2)-3*dlgmargin-hBtn,30,hEdtBx],...
    'BackgroundColor','w');

% Preview - time
uicontrol('Parent',hmain,'Style','text','String','t:',...
    'Units','pixels','Position',[width+dlgmargin+250,1+psiz(2)-3*dlgmargin-hBtn,12,hTxt],...
    'HorizontalAlignment','right');

uicontrol('Parent',hmain,'Style','edit',...
    'Tag','editPreviewTime',...
    'Callback','SIMToolbox(''editPreview_Callback'',gcbo,''t'')',...
    'Units','pixels','Position',[width+dlgmargin+262,psiz(2)-3*dlgmargin-hBtn,30,hEdtBx],...
    'BackgroundColor','w');
...
uicontrol('Parent',hmain,'Style','pushbutton','String','Run',...
    ...
    'Units','pixels','Position',[2*width-dlgmargin-150,psiz(2)-3*dlgmargin-hBtn,80,hBtn]);

% Quit button
uicontrol('Parent',hmain,'Style','pushbutton','String','Quit',...
    'Tag','btnQuit',...
    'Callback','SIMToolbox(''btnQuit_Callback'',gcbo,[])',...
    'Units','pixels','Position',[2*width-dlgmargin-60,psiz(2)-3*dlgmargin-hBtn,60,hBtn]);
