...
assert(isfilest(filename), 'ptrnopen:filenotfound', 'Pattern repertoire not found.');
...
assert(isfilest([dirname filesep fn '.yaml']), 'ptrnopen:repzempty', 'Pattern repertoire is empty.');
