...
uicontrol('Parent',hmain,'Style','pushbutton','String','Preview',...
    ...
    'Units','pixels','Position',[mainwidth+dlgmargin+95,psiz(2)-3*dlgmargin-hBtn,90,hBtn]);

% Preview - z
uicontrol('Parent',hmain,'Style','text','String','z:',...
    'Units','pixels','Position',[mainwidth+dlgmargin+187,1+psiz(2)-3*dlgmargin-hBtn,11,hTxt],...
    'HorizontalAlignment','right');
uicontrol('Parent',hmain,'Style','popupmenu',...
    ...
    'Units','pixels','Position',[mainwidth+dlgmargin+199,psiz(2)-3*dlgmargin-hBtn,35,hEdtBx]);

% Preview - time
uicontrol('Parent',hmain,'Style','text','String','t:',...
    'Units','pixels','Position',[mainwidth+dlgmargin+235,1+psiz(2)-3*dlgmargin-hBtn,10,hTxt],...
    'HorizontalAlignment','right');
uicontrol('Parent',hmain,'Style','popupmenu',...
    'Tag','popPreviewTime','String',cfg.db.preview.t,...
    'Callback','SIMToolbox(''popPreview_Callback'',gcbo,''t'')',...
    'Units','pixels','Position',[mainwidth+dlgmargin+245,psiz(2)-3*dlgmargin-hBtn,35,hEdtBx]);

% Preview - cm
uicontrol('Parent',hmain,'Style','text','String','cm:',...
    'Units','pixels','Position',[mainwidth+dlgmargin+280,1+psiz(2)-3*dlgmargin-hBtn,20,hTxt],...
    'HorizontalAlignment','right');
uicontrol('Parent',hmain,'Style','popupmenu',...
    'Tag','popPreviewColormap','String',cfg.db.preview.cm,...
    'Callback','SIMToolbox(''popPreviewColormap_Callback'',gcbo,''cm'')',...
    'Units','pixels','Position',[mainwidth+dlgmargin+300,psiz(2)-3*dlgmargin-hBtn,50,hEdtBx]);
...
uicontrol('Parent',hmain,'Style','pushbutton','String','Run',...
    ...
    'Units','pixels','Position',[2*mainwidth-dlgmargin-110,psiz(2)-3*dlgmargin-hBtn,60,hBtn]);

% Quit button
uicontrol('Parent',hmain,'Style','pushbutton','String','Quit',...
    'Tag','btnQuit',...
    'Callback','SIMToolbox(''btnQuit_Callback'',gcbo,[])',...
    'Units','pixels','Position',[2*mainwidth-dlgmargin-45,psiz(2)-3*dlgmargin-hBtn,45,hBtn]);
