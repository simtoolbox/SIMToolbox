function [A, params] = apodize_cosbell(siz, params)
% 2D cosine bell apodizing filter (Hanning window)
%
%   [A, params] = apodize_cosbell(siz, params)
%
...
% Filter definition:
%
%   A = cos(pi/2 * r/params.rad)^2   for radius <= params.rad
%   A = 0                            otherwise
%
% Example:
%
%   A = apodize_cosbell([255 255], struct('rad',0.5));
